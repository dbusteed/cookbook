...
export default function RecipeCard(props) {
  ...
  let imgSrc = urlRegex.test(recipe.img_path) ? recipe.img_path : `https://firebasestorage.googleapis.com/v0/b/sylvias-cookbook.appspot.com/o/images%2F${recipe.img_path}?alt=media`
    ...
    <div className="recipe-card">
      <Link to={`/recipe/${recipe.id}`} className="text-body text-decoration-none ">
        ...
        <div className="recipe-card-inner m-3" style={{display: "flex", flexDirection: "column", alignItems: "center"}}>
          <img className="recipe-card-img" alt="" src={imgSrc} />
